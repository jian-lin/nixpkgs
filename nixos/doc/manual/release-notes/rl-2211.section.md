...
- Emacs enables native compilation by default. But asynchronously deferred native compilation is disabled. Users can set `(setq native-comp-deferred-compilation t)` to enable it.
